...
fun RepositoryScreen(
    ...
    val error by repositoryViewModel.error.collectAsState()
            ...
            LazyColumn(
                ...
                items(repositories) { repository ->
                    RepositoryItem(
                        ...
                        onDelete = { repositoryViewModel.deleteRepository(it) }
                    )
                }
            }
            ...
            Dialog(onDismissRequest = { showRepoDialog = false }) {
                Column(
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                repositoryViewModel.addRepository(newRepoName, newRepoUrl)
                                newRepoName = ""
                                newRepoUrl = ""
